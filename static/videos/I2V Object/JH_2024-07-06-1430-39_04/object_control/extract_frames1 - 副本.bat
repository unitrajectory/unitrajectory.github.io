...
set "video_path=D:\AAAI\object_control画图cases\object_control画图cases\fine_grained_object_control_single_object\horizontal\JH_2024-07-06-1430-39_04\object_control\wan_output.mp4"
set "output_dir=D:\AAAI\object_control画图cases\object_control画图cases\fine_grained_object_control_single_object\horizontal\JH_2024-07-06-1430-39_04\object_control"
...
:: 第二步：按指定索引（0 20 40 60 80）提取目标帧
echo 正在提取指定帧...
set "target_indices=0 20 40 60 80"
for %%i in (%target_indices%) do (
    set /a "frame_num=%%i + 1"
    call :pad_with_zeros !frame_num! 6 padded_num
    copy "%temp_frames_dir%\frame_!padded_num!.png" "%output_dir%\frame1_%%i.png" >nul
