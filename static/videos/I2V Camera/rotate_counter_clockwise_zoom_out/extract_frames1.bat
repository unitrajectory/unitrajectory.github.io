...
set "video_path=D:\AAAI\images_sora_wan_results\aquarium-nyc\rotate_counter_clockwise_zoom_out\wan_output.mp4"
set "output_dir=D:\AAAI\images_sora_wan_results\aquarium-nyc\rotate_counter_clockwise_zoom_out"
