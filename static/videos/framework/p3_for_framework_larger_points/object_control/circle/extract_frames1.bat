...
set "video_path=D:\AAAI\p3_for_framework_larger_points\object_control\circle\trace.mp4"
set "output_dir=D:\AAAI\p3_for_framework_larger_points\object_control\circle"
